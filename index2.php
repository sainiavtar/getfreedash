...
?>
		<div class="container-fluid">
			<div class="row">
				<div class="col-sm-12">
					<h2 id="cch1">You are logged in <a href="/member/index.php" class="btn btn-primary">Click here to go to dashboard</a></h2>
				</div>
			</div>
		</div>
<?php
...
?>
				...
				<div class="row">
					<div class="col-sm-8 col-sm-offset-2">
						...
						<div class="setpadding"></div>
							<h1 id="cch1"><span style="color:white;">The hottest cryptocurrency DASH in your hands now.</span></h1><br><br>
							<p class="lead" id="font-text" style="font-size:30px;">Simply Sign with your phone number and get $1 worth of Dash </p><br><br>
							<p class="lead" id="font-text" style="font-size:30px;">Earn $1 for every friend who signs up using your referral link  </p><br><br><br>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="setpadding"></div>
	<div class="container">
		<h1 id="cch1">Dash is Digital Cash</h1><br>
		<p id="font-text" class="text-center">Dash is the hottest digital currency that has taken the world by a storm, send or receive any amount of money instantly and for free forever </p><hr>
		<div class="row">
			<div class="col-sm-12">
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-sm-12 getstarted">
				<h2 id="header-font" class="right">Get Started</h2><hr>
				<br>
				<p id="font-text" style="font-weight:bold;font-size:30px;">Sign up using your Phone Number</p>
				<p id="font-text">Simply enter your phone number and verify  with the OTP that we send you</p>
				...
				<div class="setpadding"></div>
				<p id="font-text" style="font-weight:bold;font-size:30px;">Get your referral link</p>
				<p id="font-text">Share your referral link with as many friends as you can, you earn $1 for friend who signs up </p>
	...
	<div class="setpadding"></div>
	<div class="container">
		<h1 id="cch1">Why is Dash the Best </h1><br>
		<p id="font-text" class="text-center">Dash is fast , cheap and instant unlike other cryptocurrencies</p><hr>
		<div class="row">
			<div class="col-sm-12">
				<div class="embed-responsive embed-responsive-16by9">
					<iframe class="embed-responsive-item" src="//youtube.com/embed/S0oNO3mbBE8?rel=0&amp;showinfo=0&amp;start=0"></iframe>
			...
			<div class="col-sm-8 getstarted">
				...
				<form>
					<div class="form-group">
						<label class="control-label col-sm-2 col-sm-offset-1" for="email"><span id="font-text" style="font-size:30px;">Subscribe </span> </label>
						<div class="col-sm-6">
		...
		<div class="row">
			...
			<div class="row">
				<form class="form" action="" method="POST"><!--Header-->
					...
					<div class="col-sm-offset-2 col-sm-8">
					<div class="md-form"><textarea id="form8" class="md-textarea" name="query"></textarea> <label class="active" for="form8">Message</label></div>
					</div>
					<input name="formid" type="hidden" value="1000" /></div>
					<div class="col-sm-offset-2 col-sm-8">
					<div class="text-center"><button class="btn btn-default">Submit</button></div>
					</div>
				</form>
			</div>
			</div>

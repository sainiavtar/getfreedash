...
?>
	<div class="container" style="margin-top:10px;">
		<div class="row">
			<div class="col-sm-offset-3 col-sm-6">
				...
				<button type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target="#myModalReferral">Get Referral Link</button>
				<a type="button" class="btn btn-success btn-lg" href="user_detail.php">User Details</a>
				<a type="button" class="btn btn-success btn-lg" href="login.php?logout">Log Out</a>
			</div>
		</div>
	</div>
  ...
  <option data-countryCode="US" value="1">USA (+1)</option>
	  ...
	  <div class="modal-dialog">
		...
		<div class="modal-content">
		  ...
		  <div id=""></div>
				...
				?>
				<h2 class="bg-success" style="border-radius:15px;">Congratulation! Sign Up Successful!!!<a href="<?php echo $goto; ?>" class="btn btn-info" role="button">Close</a></h2>
				<div class="setpadding"></div>
		  </div>
		</div>
	...
	<!-- Referral modal-->
	<div id="myModalReferral" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
	  <div class="modal-dialog">
		...
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			...
			<div class="container-fluid" style="background-color:#e6e6e6;margin-top:40px;padding-top:10px;">
				...
				<div class="setpadding"></div>
				<div class="form-group">
				  <label for="referral" class="sr-only">Enter your mobile number for generate referral link.</label>
				  <input name="refno" type="text" class="form-control" id="refno" placeholder="Enter Mobile Number">
				</div>
				<button type="button" class="btn btn-success btn-lg referralsuccess">Next</button>
				<button class="btn btn-danger btn-lg" type="button" data-dismiss="modal">Close</button>
				<div class="setpadding"></div>
	...
	<div id="referralsuccess" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
	  <div class="modal-dialog">
		...
		<div class="modal-content">
		  ...
		  <div class="modal-body">			
			<div class="container-fluid" style="background-color:#e6e6e6;margin-top:40px;padding-top:10px;">
				<div class="setpadding"></div>
				<h3>Your referral link is given below</h3><br>
				<div class="setpadding"></div>
				<div id="msg5"></div>
				<div class="setpadding"></div>
				<button class="btn btn-danger btn-lg" type="button" data-dismiss="modal">Close</button>

	  ...
	  <div class="modal-dialog">
		...
		<div class="modal-content">
			<div class="modal-header">
				<div class="text-center"><h3>Step 1 / 3</h3></div>
			</div>
		  <div class="modal-body">
			<div class="text-center"><div id="msg"></div></div>
			<div class="text-center"><strong class="modalcontentfirst" style="padding:10px 10px;border-radius:25px;font-size:18px;">Sign Up To Get $1 Free.</strong></div>
...
<!-- Modal Sign Up 2st Step-->
	<div id="stepsec" class="modal custom fade" role="dialog" data-backdrop="static" data-keyboard="false">
	  <div class="modal-dialog">
		...
		<div class="modal-content">
			<div class="modal-header">
				<div class="text-center"><h3>Step 2 / 3</h3></div>
			</div>
		  <div class="modal-body">
			<div id="msg2"></div>
			<div class="container-fluid" style="background-color:#00cccc;margin-top:40px;padding-top:10px;">
	...
	<div id="stepthird" class="modal custom fade" role="dialog" data-backdrop="static" data-keyboard="false">
	  <div class="modal-dialog">
		...
		<div class="modal-content">
			<div class="modal-header">
				<div class="text-center"><h3>Step 3 / 3</h3></div>
			</div>
		  <div class="modal-body">
	...
	<div id="success" class="modal custom fade" role="dialog" data-backdrop="static" data-keyboard="false">
	  <div class="modal-dialog">
		...
		<div class="modal-content">
			<div class="modal-header">
				<div class="text-center"><h3>Congratulation! Sign Up Successful!!!</h3></div>
			</div>
		  <div class="modal-body">
			  <div class="container-fluid" style="background-color:#00cccc;margin-top:40px;padding-top:10px;">
					<div class="setpadding"></div>
						<h2>You will get $1 shortly in your dash wallet account.<br></h2>
						<div class="setpadding"></div>
							<a href="" class="btn btn-danger" role="button">Close</a>
					<div class="setpadding"></div>
			  </div>
		...
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			<div class="container-fluid" style="background-color:#00cccc;padding-top:10px;">
					<div class="row">
						<div class="col-sm-8 col-sm-offset-2">
							<div class="text-center"><strong class="text-center" style="padding:10px 10px;border-radius:25px;font-size:18px;">Enter your registered email address below</strong></div>

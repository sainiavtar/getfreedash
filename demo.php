...
<br>
<br>
	<div class="container-fluid" style="background-color:#4d94ff;">
		<div class="row">
			<div class="col-sm-6" style="background-color:yellow;">
				<p id="cch1" style="color:white;margin:10px;">Your referral link is</strong></p>
			</div>
			<div class="col-sm-6" style="color:white;background-color:red;">
				<p id="cch1" style="color:white;margin:10px;">Your referral link is</strong></p>
			</div>
		</div>
	</div>
